...
```mermaid
---
title: Remote search and download
---
flowchart LR
  accTitle: Remote search and download pipeline
  accDescr: A font query passes through enabled providers, aggregation and cache, normalization and ranking, presentation, and validated download.
...
---
flowchart LR
  accTitle: Local font conversion pipeline
  accDescr: A local font passes through content-based format detection, WOFF2 encoding or decoding, output validation, and an atomic file commit.
